...
export IMAGE_URL=${IMAGE_URL-quay.io/rhtap_qe/go-tvcdjqns:$CI_TYPE-$TAG}
...
export GITOPS_REPO_URL=https://github.com/rhtap-rhdh-qe/go-tvcdjqns-gitops
...
export COSIGN_PUBLIC_KEY="LS0tLS1CRUdJTiBQVUJMSUMgS0VZLS0tLS0KTUZrd0V3WUhLb1pJemowQ0FRWUlLb1pJemowREFRY0RRZ0FFTWQxM1d3VFh5RXhJTnJLR0ZtMGdmQkJDYlNyMQp4Uk1yTHplZ21TWG5GZWp5MDg3RUlvclJIaXlKZVY1OUtVTC8xWE42VlU5U0VlYy83V2lYRG1WMXdBPT0KLS0tLS1FTkQgUFVCTElDIEtFWS0tLS0tCg=="
...
export REKOR_HOST=${REKOR_HOST-https://rekor-server-tssc-tas.apps.rosa.kx-227b2501a7.xz44.p3.openshiftapps.com}
...
export TUF_MIRROR=${TUF_MIRROR-https://tuf-tssc-tas.apps.rosa.kx-227b2501a7.xz44.p3.openshiftapps.com}
